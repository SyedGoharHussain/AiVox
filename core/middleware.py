...
INTERNAL_TOOL_TOKEN = os.environ.get("AIVOX_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-AiVox-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-AiVox-Internal-Token), or
