...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'aivox-model-expanded',
  MODEL_ENDPOINTS: 'aivox-model-endpoints',
  MODEL_SELECTED: 'aivox-selected-model',
  SORT_ORDER: 'aivox-sessions-sort',
  CHAT_SEARCH_SCOPE: 'aivox-search-scope',
  INCOGNITO: 'aivox-incognito',
  RAG_ACTIVE: 'aivox-rag-active',
  MCP_ACTIVE: 'aivox-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'aivox-density',
  WORKSPACE: 'aivox-workspace'
};
