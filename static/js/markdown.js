...
function initMermaid() {
  if (!window.mermaid || window.__aivoxMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__aivoxMermaidReady = true;
}
window.aivoxInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'aivox-thinking-expanded';
