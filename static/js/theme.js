...
export const THEMES = {
  dark: { bg:'#121212', fg:'#FFFFFF', panel:'#4E342E', border:'#5D4037', red:'#8D6E63' },
  light: { bg:'#f0ebe3', fg:'#5a5248', panel:'#faf6f0', border:'#d4cdc2', red:'#c47d5a' }
};

const DEFAULT_THEME = 'dark';
const LS_KEY = 'aivox-theme';
const CUSTOM_THEMES_KEY = 'aivox-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'AiVox Logo',    group: 'Sidebar' },
...
function _updateFavicon(fg) {
  ...
  if (routeShape) {
    ...
    svg = `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><path d='M16 3C10 3 6 8 6 14v4l-2 3v1h24v-1l-2-3v-4c0-6-4-11-10-11z' fill='${fg}'/><path d='M6 14h20v4H6z' fill='${fg}' opacity='0.5'/><path d='M12 25c0 2.2 1.8 4 4 4s4-1.8 4-4' fill='none' stroke='${fg}' stroke-width='2'/></svg>`;
  }
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'aivox_' + (obj.name || 'theme') + '.json';
      a.click();
