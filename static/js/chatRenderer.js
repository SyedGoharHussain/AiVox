...
const _ACTION_RECENTS_KEY = 'aivox-msg-actions-recent';
 ...
 */
const _USER_ACTION_RECENTS_KEY = 'aivox-user-actions-recent';
...
export function addMessage(role, content, modelName, metadata) {
  try {
    ...
    var _roleText = role === 'user' ? 'You' : (isSlash || isCompacted) ? 'AiVox' : modelRouteLabel(replyModels.requestedModel, resolvedModel);
