"""scripts/_lib/cli.py — shared scaffolding for the `aivox-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("aivox-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/aivox-foo`
...
VERSION = "0.1.0"  # bumped centrally; every aivox-* CLI reports this
