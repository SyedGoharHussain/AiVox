...
COPILOT_USER_AGENT = os.environ.get(
    "AIVOX_COPILOT_USER_AGENT", "AiVox/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "AIVOX_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "AIVOX_COPILOT_EDITOR_VERSION", "AiVox/1.0"
)
