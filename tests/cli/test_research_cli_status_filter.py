"""`aivox-research list --status complete` was returning nothing.
...
Part of #2122 (aivox-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "aivox-research"
    loader = importlib.machinery.SourceFileLoader("aivox_research_cli", str(path))
